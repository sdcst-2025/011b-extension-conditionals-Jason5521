...
print("You decide to break into the lighthouse.")
print("")
...
print("")
print("Within the lighthouse lies a radio, a device labeled [black on yellow]*DO NOT TOUCH*[/black on yellow], and the stairs to the top.")
print("")
